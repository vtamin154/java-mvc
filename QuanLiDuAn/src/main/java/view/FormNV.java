...
public class FormNV extends javax.swing.JPanel {
    ...
    public FormNV() {
        ...
        String cols[] = {"Mã nhân viên", "Tên nhân viên", "Địa chỉ", "Chuyên môn"};
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            String cm = model.getValueAt(i, 3).toString();
            NhanVien nv = new NhanVien(ma, ten, dc, cm);
            list.add(nv);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (them) {
            ...
            if (cm.length() == 0) {
                JOptionPane.showMessageDialog(this, "Chuyen mon khong hop le!");
                isOk = false;
            }
            if (isOk) {
                nv = new NhanVien(ma, ten, dc, cm);
                model.addRow(nv.toObject());
                them = false;
            }
        }
