...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        setSize(900, 600);
        FormHang mh = new FormHang();
        jTabbedPane1.add("Thông tin mặt hàng", mh);
        FormNhanVien nv = new FormNhanVien();
        jTabbedPane1.add("Thông tin nhân viên", nv);
        FormQuanLi ql = new FormQuanLi();
        jTabbedPane1.add("Quản lí bán hàng", ql);
    }
