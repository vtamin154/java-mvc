...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        setSize(900, 600);
        FormCongNhan cn = new FormCongNhan();
        jTabbedPane1.add("Thông tin công nhân", cn);
        FormXuong xsx = new FormXuong();
        jTabbedPane1.add("Thông tin xưởng", xsx);
        FormChamCong cc = new  FormChamCong();
        jTabbedPane1.add("Chấm công", cc);
    }
