...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        FormKhach khach = new FormKhach();
        jTabbedPane1.add("Thông tin khách hàng", khach);
        FormDIenThoai dt = new FormDIenThoai();
        jTabbedPane1.add("Thông tin san phẩm", dt);
        FormHoaDon hd = new FormHoaDon();
        jTabbedPane1.add("Hoá đơn", hd);
    }
