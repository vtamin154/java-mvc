...
public class Home extends javax.swing.JFrame {
    ...
    public Home() {
        initComponents();
        FormPV pv =new FormPV();
        jTabbedPane1.add("Thông tin phóng viên", pv);
        FormBV bv =new FormBV();
        jTabbedPane1.add("Thông tin bài viết", bv);
        FormCC cc =new FormCC();
        jTabbedPane1.add("Bảng tính công", cc);
    }
